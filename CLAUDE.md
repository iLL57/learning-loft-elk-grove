...
## Pending TODOs
- [ ] Set up custom sending domain on Resend (e.g. noreply@thelearninglofteg.com) so enrollment notification emails don't come from onboarding@resend.dev and don't land in spam
- [ ] Build admin page for viewing enrollment submissions (password-protected via Supabase Auth)
- [ ] Delete test submission (id: eaea48ce-9367-482d-9a94-a7064af21fec) from enrollment_submissions table once admin page is built
